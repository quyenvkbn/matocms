                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="col-xs-12" style="padding-bottom: 10px;">
                                            <div class="col-xs-12 required" id="parent_configuration" style="padding: 0px;">
                                                ...
                                                ?>
                                                <select name="type_configuration"  class="form-control type_configuration">
                                                    ...
                                                    <div class="col-xs-12 drop-drag" draggable="false" ondragstart="drag(event)">
                                                        ...
                                                        <div id="demo<?php echo $i;?>" class="collapse in form-group">
                                                            <div class="col-xs-12" style="padding: 0px;">
                                                                ...
                                                                <div class="col-sm-6 col-xs-12" id="list<?php echo $i;?>">
                                                                    ...
                                                                    <select name="type[]"  class="form-control select_type" onchange="select(this,'<?php echo $i;?>')" disabled>
                                                                        ...
                                                                        <option value="select"<?php echo ($i == 3)? 'selected' : '' ?>>Select</option>
                                                            ...
                                                            <div class="col-xs-12" style="padding: 0px;">
                                                                ...
                                                                <div class="col-sm-6 col-xs-12 checkbox_field">
                                                                    ...
                                                                    <?php elseif ($i == 3): ?>
                                                                        <div class="checkbox check_multiple" style="padding:0px;">
                                                                            <label class="checkbox-inline"><input type="checkbox" name="" value="" class="select_multiple" onclick="check_multiple(this)" disabled>Được phép chọn nhiều</label>
                                                                        </div>
                                                                    <?php elseif ($i == 5): ?>
                                                                        <div class="check_multiple" style="padding:0px;">
                                                                ...
                                                                <div class="col-xs-12">
                                                                    <label class="checkbox-inline">
                                                                        <input type="checkbox" name="" class="required_check" onclick="check_required(this)"/ <?php echo (in_array($i,array(2,3,4)))? 'checked disabled' : ''; ?>><span>Bắt buộc chọn hoặc nhập thông tin</span>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                            <?php if (in_array($i,array(2,3,4))): ?>
...
<script src="<?php echo site_url('assets/public/js/admin/') ?>templates.js"></script>