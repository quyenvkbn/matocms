            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Category 2</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <a href="<?php echo base_url('admin/products/creatCategory_2') ?>" class="btn btn-primary" role="button">Add Item</a>
                            ...
                            <table id="table" class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url('admin/products/editCategory_2') ?>" id="dataActionEdit"><i class="fa fa-pencil" aria-hidden="true"></i> </a>
