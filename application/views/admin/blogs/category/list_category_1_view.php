        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <a href="<?php echo base_url('admin/products/creatCategory_1') ?>" class="btn btn-primary" role="button">Add Item</a>
                        <div class="table-responsive">
                            <table id="table" class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url('admin/products/editCategory_1') ?>" id="dataActionEdit"><i class="fa fa-pencil" aria-hidden="true"></i> </a>
